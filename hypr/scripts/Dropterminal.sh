...
WIDTH_PERCENT=80  # Width as percentage of screen width
HEIGHT_PERCENT=80 # Height as percentage of screen height
X_PERCENT=10      # X position as percentage from left (25% centers a 50% width window)
